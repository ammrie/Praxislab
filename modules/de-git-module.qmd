...
![](../images/64_git-init.PNG){width=50% height=50%}
...
![](../images/64_add-commit-push.PNG){width=50% height=50%}
...
![](../images/64_git-status.PNG){width=50% height=50%}
...
<iframe width="100%" height="3600px" src="http://137.248.191.201:3838/de/git-1/"   scrolling="no" frameborder="0"> </iframe>
...
<iframe width="100%" height="2250px" src="http://137.248.191.201:3838/de/git-2/"   scrolling="no" frameborder="0"> </iframe>
...
<iframe width="100%" height="2100px" src="http://137.248.191.201:3838/de/git-3/"   scrolling="no" frameborder="0"> </iframe>
...
<iframe width="100%" height="2100px" src="http://137.248.191.201:3838/de/git-4/"   scrolling="no" frameborder="0"> </iframe>

## Danksagung

Das Tutorial basiert auf dem [DoSStoolkit](https://dosstoolkit.com/). Sowohl die Inhalte als auch die Self Assessments basieren dem Modul [Git outta here](https://dosstoolkit.com/#git-outta-here) von [Mariam Walaa & Matthew Wankiewicz](https://dosstoolkit.com/#contributors). Die Übersetzungen und Veränderungen vom Author dieser Seite. 
