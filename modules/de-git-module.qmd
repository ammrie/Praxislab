...
graph LR
    ...
    C[Datei im <br>Staging Area] --> 
    D[Dateiversion im <br> Lokalen Repository ] --> 
    E[Dateiversion im <br> Remote Repository ]
    
    AA[Projektordner <br> 'MeinOrdner'] -.git init.-> 
    BB[Ordner ist als  <br> Repository vorbereitet] -.git add DateiNeu.->
    CC(Die DateiNeu wird 'überwacht') -.git commit.-> 
    DD(Die Datei DateiNeu ist <br> im aktuellen Zustand lokal gespeichert) -.git push.-> 
    EE(Die DateiNeu  ist <br> auf dem GitHub Repo gespeichrt)
