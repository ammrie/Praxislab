...
graph LR
    ...
    A[Create a <br> new folder] -- mkdir MyFolder --> B[Local folder <br> MyFolder]
    B -- git init --> C[Local repository <br> MyFolder]
    C -.- D(git monitors <br> MyFolder <br> knows but contents)  
