...
The current slides are using the following yaml header:
![](slide1/preview-image-mof.png)
...
You see a basic head and foot line in addition with some kind of logo.
...
To activate highlighting Press `R` to activate notation animations
